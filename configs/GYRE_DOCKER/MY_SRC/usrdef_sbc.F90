...
CONTAINS
   ...
   SUBROUTINE usrdef_sbc_oce( kt, Kbb )
      ...
      ! Seasonal cycle REMOVED to match Bagaeva et al. (2024) steady forcing
      zcos_sais1 = 0._wp
      zcos_sais2 = 0._wp

      ztrp= - 4.e0         ! retroaction term on heat fluxes (W/m2/K) — Bagaeva: gamma=4
      ...
      END_2D
      ! E-P flux REMOVED — Bagaeva: constant salinity, no freshwater forcing
      ...
      ! mean intensity at 0.105 ; sqrt(2) because projected with 45deg angle
      ztau = 0.105 / SQRT( 2. )
      ! Seasonal cycle REMOVED — steady wind forcing (Bagaeva et al. 2024)
      ztaun = ztau
      DO_2D( nn_hls, nn_hls, nn_hls, nn_hls )
